    ...
    $(".design-btn").click(function () {
      if ($(this).hasClass("active")) {
        ...
        setTimeout(function () {
          ...
          $(
            ".mouse-pos-list-image li.design, .mouse-pos-list-image-wrap li.design, .work-tiles li.design"
          ).addClass("visible");
        }, 300);
      }
    });
    $(".development-btn").click(function () {
      if ($(this).hasClass("active")) {
        ...
        setTimeout(function () {
          ...
          $(
            ".mouse-pos-list-image li.development, .mouse-pos-list-image-wrap li.development, .work-tiles li.development"
          ).addClass("visible");
        }, 300);
      }
    });
...
function initContactForm() {
  $(".field").on("input", function () {
    $(this)
      .parent()
      .toggleClass("not-empty", this.value.trim().length > 0);
  });
  ...
  $(function () {
    $(".field")
      .focusout(function () {
        ...
        $(this)
          .parent()
          .toggleClass("not-empty", text_val !== "");
      })
      .focusout();
  });
}
    ...
    "(min-width: 721px)": function () {
      ...
      if (document.querySelector(".about-services")) {
        ...
        $(".about-services").each(function (index) {
          let triggerElement = $(this);
          let targetElement = $(
            ".about-header, .line-globe, .about-image, .about-services"
          );
